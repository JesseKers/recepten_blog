...
CREATE TABLE auteur (
	auteur_id int NOT NULL PRIMARY KEY AUTO_INCREMENT,
	auteur varchar(50)
);

ALTER TABLE posts ADD COLUMN auteur_id int;

UPDATE posts SET auteur_id = 1 WHERE id = 1;

UPDATE posts SET auteur_id = 3 WHERE id = 2;

INSERT INTO auteur (auteur)
VALUES
	('Wim Ballieu'),
	('Miljuschka'),
	('Mounir Toub');
